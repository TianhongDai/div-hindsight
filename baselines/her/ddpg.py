...
from baselines.her.replay_buffer import ReplayBuffer, ReplayBufferDiversity
...
class DDPG(object):
    ...
    def store_episode(self, episode_batch, dump_buffer, clip_div, update_stats=True):
        """
        episode_batch: array of batch_size x (T or T+1) x dim_key
                       'o' is of size T+1, others are of size T
        """
        if self.prioritization == 'diversity':
            self.buffer.store_episode(episode_batch, clip_div)
        else:
